@echo off
echo ============================================================
echo Clean Install TensorRT 10.7 + cuDNN 9.13.1 (CUDA 12.1)
echo ============================================================
echo.
pause
...
echo.
echo Removing old TensorRT 8.6 files...
rmdir /s /q python_packages\tensorrt
del python_packages\nvinfer*.dll 2>nul
del python_packages\nvonnx*.dll 2>nul
del python_packages\nvparsers*.dll 2>nul
...
echo.
echo If you see TensorRT version 10.7.0 above, installation complete!
echo.
pause
