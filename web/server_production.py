...
REDIS_URL = None
redis_url_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'redis_url.txt')
if os.path.exists(redis_url_file):
    ...
    if REDIS_URL == 'redis://:watermarkz_secure_2024@localhost:6379/0':
        print("⚠️ WARNING: Using localhost Redis - run START_ALL.bat to use ngrok tunnel!")
