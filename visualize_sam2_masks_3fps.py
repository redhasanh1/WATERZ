"""
SAM2 Mask Visualization Tool - 3 FPS MODE
...
**3 FPS MODE**: Automatically spreads masks across all video frames
Example: If you have 70 masks and 1100 frames, each mask repeats ~16 times
...
OUTPUT_VIDEO = "results/sam2_mask_visualization_3fps.mp4"
...
def visualize_masks():
    """Create visualization video showing masks overlaid on frames - 3fps mode."""

    print("\n" + "="*70)
    print("SAM2 MASK VISUALIZATION - 3 FPS MODE")
    print("="*70 + "\n")
    print("Auto-spreads masks across all video frames")
    print()
    ...
    print(f"[3FPS] Auto-calculating repeat count:")
    ...
    print("[PROCESSING] Creating visualization video (3fps mode)...")
    ...
    while True:
        ...
        # Load corresponding mask (same mask for multiple consecutive frames)
