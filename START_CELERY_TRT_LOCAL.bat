...
REM ✅ LOCAL MODE: Disable Railway upload, save to local results/ folder
echo ============================================================
echo LOCAL MODE: Railway upload DISABLED
echo Results will be saved to: D:\watermarkz\results\
echo ============================================================
echo.
...
echo Starting Celery worker - LOCAL MODE (TensorRT NeuFlow v2 FP16)...
echo.
echo ============================================================
echo TENSORRT MODE: NeuFlow v2 TensorRT FP16 (4 execution contexts, pure GPU)
echo LOCAL MODE: Results saved to D:\watermarkz\results\ (no Railway upload)
echo ============================================================
echo.
...
echo.
echo ============================================================
echo OPTIMIZED CONFIG (RTX 4090) - LOCAL MODE:
...
echo   - OUTPUT: D:\watermarkz\results\ (LOCAL MODE - no Railway upload!)
echo ============================================================
echo.
