...
set "output_video=%video_dir%%video_name%_3fps.mp4"

echo Converting to 3 FPS (keeping original resolution)...
echo.

REM Use Python script with static-ffmpeg (same approach as 16fps converter)
"%LOCALAPPDATA%\Programs\Python\Python312\python.exe" "%~dp0convert_to_3fps.py" "%input_video%"
