...
print(f"Estimated time: ~{total_frames * 0.8 / 60:.1f} minutes (0.8sec per frame)")

# Create output
fourcc = cv2.VideoWriter_fourcc(*'mp4v')
out = cv2.VideoWriter('asser_clean_lama.mp4', fourcc, fps, (width, height))

success_count = 0
last_position = None
padding = 30

print("\nProcessing asser.mp4 with LaMa AI...")
...
print(f"Output: asser_clean_lama.mp4")
