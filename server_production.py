...
# ----------------------------------------------------------------------------
# Email Verification - uses email_utils.py with Brevo HTTP API
# ----------------------------------------------------------------------------
from email_utils import send_verification_email as _send_verification_email_util
...
def send_verification_email(to_email, token):
    ...
    try:
        ...
        _send_verification_email_util(to_email, verify_url)
        return True
    except Exception as e:
